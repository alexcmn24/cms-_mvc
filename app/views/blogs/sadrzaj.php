      ...
      <div class="pull-right">
        <div id="search_polje_div" class="box-tools pull-left">
          <div class="has-feedback">
            <input id="search_blog_polje" type="text" class="form-control input-sm" placeholder="Search Blog">
    ...
    <div class="box-body">
      <div class="table-responsive">
            ...
            <?php if(isset($_SESSION['svi_blogovi'])): ?>
              <?php foreach($_SESSION['svi_blogovi'] as $blog): ?>
                <tr>
                  ...
                  <td class="text-center"><?php echo $blog->ime_i_prezime; ?></td>
        ...
        <?php if(isset($_SESSION['stranica'])): ?>
          <ul class="pagination pull-right" id="pager-session">
